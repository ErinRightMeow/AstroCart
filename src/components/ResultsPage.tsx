        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-lg border border-purple-100 mb-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {cities.map((city, index) => (
                <div key={city.name} className="bg-white rounded-2xl p-6 hover:shadow-lg transition-all duration-300 border border-slate-200">
                  ...
                  {/* City-specific Action Links */}
                  <div className="space-y-2">
                    <button className="w-full px-4 py-2 bg-gradient-to-r from-blue-300 to-indigo-300 text-white font-medium rounded-lg hover:shadow-lg transition-all duration-200 flex items-center justify-center text-sm">
                      <Briefcase className="w-4 h-4 mr-2" />
                      Job Opportunities
                    </button>
                    <button className="w-full px-4 py-2 bg-gradient-to-r from-green-300 to-emerald-300 text-white font-medium rounded-lg hover:shadow-lg transition-all duration-200 flex items-center justify-center text-sm">
                      <Calendar className="w-4 h-4 mr-2" />
                      Networking Events
                    </button>
                    <button className="w-full px-4 py-2 bg-gradient-to-r from-purple-300 to-violet-300 text-white font-medium rounded-lg hover:shadow-lg transition-all duration-200 flex items-center justify-center text-sm">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              ...
              Back to Choose Different Influence
            </button>
            {user && (
              <button
                onClick={saveReading}
